    ...
    return (
      <div className="container is-tablet">
        ...
        */}
          ...
          <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2039.0864301645151!2d18.17694285124697!3d59.264705023154875!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x465f78dfa34ccae3%3A0x99e6ddb221dc6bbc!2zw4RsdGF2w6RnZW4gMTU5QiwgMTM4IDM3IMOEbHRh!5e0!3m2!1ssv!2sse!4v1517860723197" width="600" height="450" frameborder="0"></iframe>
        </Section>
        <Section className="name-section">
          <div className="name-container italic">
        ...
        */}
          <p>
            <b>Klädkod för män:</b> Klädkoden innebär hel kostym, men den kan vara i en lite ljusare nyans om man vill. Till det kan männen bära slips eller fluga. Jeans är däremot inte okej.
        </p>
          <p>
            <b>Klädkod för kvinnor:</b> Som kvinna kan du bära en klänning, kjol eller byxdress som är finare än en vanlig vardagsklädsel men inte lika tjusig som aftonklänning. En hellång klänning är för uppklätt men du kan välja en modell som är vadlång eller knälång.
        </p>
        </Section>
